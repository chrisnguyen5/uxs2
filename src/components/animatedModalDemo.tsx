        ...
        <ModalBody>
          <ModalContent>
            ...
            <div className="py-10 flex flex-wrap gap-x-4 gap-y-6 items-start justify-start max-w-sm mx-auto">
              ...
              <div className="flex items-center justify-center">
               Great question! The annual cost of a full-time senior-level designer now exceeds over $7,000 per month, 
               ...
               plan that is nearly half the cost, you can pause and resume your subscription as often as you need to ensure 
